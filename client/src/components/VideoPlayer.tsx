          ...
          >
            ...
            >
              <div className="relative">
                ...
                {/* Actual button */}
                <button className="bg-white text-theme-primary p-3 rounded-full transform transition-all duration-300 shadow-lg relative z-10 group-hover:bg-theme-primary group-hover:text-white">
              ...
              <div className="flex flex-wrap items-center gap-1">
                ...
                {video.categories.slice(0, 2).map((category) => (
                  <Badge
                    key={category}
                    variant="outline"
                    className="bg-slate-50 text-slate-600 border-slate-100 text-xs px-2 py-0 h-5"
                  >
                    {category}
                  </Badge>
                ))}
