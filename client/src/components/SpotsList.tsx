...
import { Wind, Waves, Thermometer, ChevronRight, MapPin, Sparkles } from "lucide-react";
...
export default function SpotsList({ spots, onSpotSelect, isLoading, selectedMonth }: SpotsListProps) {
  return (
    <Card className="w-full md:w-1/3 overflow-y-auto rounded-xl border border-slate-100 shadow-sm" style={{ maxHeight: "calc(100vh - 16rem)" }}>
          ...
          spots.map((spot, index) => (
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button 
                  variant="ghost"
                  className="text-primary font-medium mt-2 flex items-center justify-start hover:text-primary/80 transition-all duration-300 hover:bg-primary/5 p-0"
