          ...
          <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
            ...
            <div className="flex items-center justify-between md:justify-start gap-3 flex-wrap">
              ...
              <Button 
                ...
                variant="default"
                className="text-white h-9 px-3 shadow-md text-sm font-medium transition-all duration-300"
                size="sm"
              >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex gap-2 items-center mt-2 sm:mt-0">
              <Button
                ...
                className={`h-9 text-xs px-3 ${spotsToCompare.length >= 2 ? "bg-yellow hover:bg-yellow/60 text-slate shadow-md" : "bg-white"}`}
              >
