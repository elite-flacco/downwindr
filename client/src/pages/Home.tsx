  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="container mx-auto px-4 py-6 flex-grow">
        {/* Page Title */}
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-neutral-dark">Find Perfect Kitesurfing Spots</h2>
          <p className="text-gray-600">Discover the best kitesurfing locations worldwide based on optimal wind conditions by month</p>
        </div>
