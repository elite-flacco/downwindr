  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="relative py-24 md:py-28 lg:py-32 bg-gradient-to-r from-cyan-50 to-blue-50 overflow-hidden">
          {/* Background pattern */}
          <div 
            ...
            <div className="flex flex-col lg:flex-row items-center">
              ...
              <div className="w-full lg:w-1/2 mb-10 lg:mb-0 z-10">
                <motion.div
                  ...
                  className="bg-white/70 backdrop-blur-md p-8 md:p-10 rounded-xl shadow-sm border border-white/60"
                >
                  <h1 
              ...
              <div className="w-full lg:w-1/2 lg:absolute lg:right-0 lg:top-0 lg:bottom-0 overflow-hidden">
                ...
                >
                  ...
                  <div className="absolute lg:-right-32 lg:top-0 lg:bottom-0 lg:w-[700px] w-full flex items-center">
