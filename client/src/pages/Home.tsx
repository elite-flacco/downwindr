          ...
          <div className="container mx-auto px-4 relative z-10 max-w-screen-lg">
            <div className="max-w-xl">
              <motion.div
                ...
                className="bg-white/75 backdrop-blur-md p-8 md:p-10 rounded-xl shadow-sm border border-white/80"
              >
                <h1 
